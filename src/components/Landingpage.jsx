...
function Landingpage() {
    ...
    // useEffect(()=>{
    //     if(winWidth>="640") {setWidth("70px"); setheight("46px")}
    //     if(winWidth>="768") {setWidth("100px"); setheight("56px")}
    //     if(winWidth>="1024") {setWidth("11vw"); setheight("5.8vw")}
    //     console.log(winWidth);
    // },[window.innerWidth])
  return (
    //Test_Founders_Grotesk_X-Cond_SmBd
    <div data-scroll data-scroll-section data-scroll-speed="-0.5" className="w-full h-[99vh] bg-[#F1F1F1] font-['Founders_Grotesk'] border ">
            <div className="maintxt h-1/2 mt-40 lg:mt-44 ml-5 lg:ml-12 text-[47px] md:text-[62px] lg:text-[6vw] font-extrabold leading-none tracking-tighter">
                {["WE CREATE","EYE-OPENING","PRESENTATIONS"].map((item,index)=>{
                    return (
                        <div key={index} className="masker flex leading-[51px] md:leading-[68px] lg:leading-[6.5vw]">
                            {index === 1 && (<div className="w-[70px] h-[46px] md:w-[100px] md:h-[56px] lg:w-[11vw] lg:h-[5.8vw] -mt-[11px] lg:-mt-5 lg:mr-2 rounded-lg lg:rounded-xl bg-[url('.\Images\content-image01.jpg')] bg-cover">
                                <motion.div initial={{width:0}} animate={{width:"100%"}}  className={`w-full h-full bg-[url('.\Images\content-image01.jpg')] bg-cover`}> 
                                    
                                    </motion.div>
                            </div>)}
                            <h1 className='scale-x-100 scale-y-150 '>
                                {item}
                            </h1>
                        </div>
                    )
            ...
            <div className="lower border-t-[1px] border-gray-400 -mt-14 lg:mt-[2.9vw] pt-1">

                <div className='md:h-14 mx-11 mt-1 flex flex-col lg:flex-row justify-between text-lg text-[#212121]'>
                    <div id="left" className='lg:w-1/2 mt-3'>
                        <a href="#">For public and private companies</a>
                    </div>
                    <div id="right" className='lg:w-1/2 flex flex-col lg:flex-row justify-between'>
                        <div id="subright" className='mt-3'>
                            <p>
                            From the first pitch to IPO
                            </p>
                        </div>
                        <div id="subleft" className='flex gap-1'>
                            <button className='p-1 px-4 rounded-full border border-gray-800 mt-1 h-8 text-lg uppercase'>
                                start the project
                            </button>
                            <div className='border border-black w-8 h-8 mt-1 rounded-full flex justify-center items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="rgba(30,30,30,1)"><path d="M16.0037 9.41421L7.39712 18.0208L5.98291 16.6066L14.5895 8H7.00373V6H18.0037V17H16.0037V9.41421Z"></path></svg> 
                            </div>
        ...
        <div className="scale-75 origin-top-right md:scale-100 absolute top-40 right-0">
        ...
        <div className='absolute left-1/2 bottom-0  overflow-hidden h-6 text-gray-400'>
            <motion.h4 initial={{y:0}} animate={{y:"100%"}} transition={{ease:"linear" ,repeat:Infinity, duration:1}} className='text-lg'>Scroll Down </motion.h4>
        </div>
    </div>
  )
}
