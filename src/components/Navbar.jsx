...
function Navbar() {
  ...
  return (
    <div className=" z-[999] fixed w-full px-4 lg:px-12 py-4 flex justify-between">
      ...
      <div className="w-1/2 flex justify-end items-center lg:hidden text-[#212121]">
      ...
      <div className="menubtns w-1/2 pt-1 justify-between text-[17px] font-['Neue_Montreal'] font-normal text-[#212121] hidden lg:flex">
      ...
      {menuOpen && (
        <div className="lg:hidden h-full bg-[#212121] fixed top-0 left-0 z-50 w-full flex flex-col justify-start items-start">
          <div className="left w-full absolute top-[17vh] font-['Neue_Montreal'] border-t border-gray-600  flex flex-col gap-7 leading-none text-[7vw] font-extrabold pl-4 text-white pt-6">
            {["Services", "Our work", "About us", "Insights", "Contact us"].map(
              (item, index) => {
                return <a href="#" className="-mt-3">{item}</a>;
              }
            )}
          </div>
          {/* Close menu button */}
          <button
            className="text-white absolute top-5 right-3"
            onClick={toggleMenu}
          >
            <svg
              className="h-7 w-7"
